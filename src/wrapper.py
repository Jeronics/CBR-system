...
class Match(Case):
    def __init__(self, params):
        ...
        # self.problem.add_feature(name='params', values={p: params[p] for p in odd_params if p in params})
...
def similarity_function(train_match, test_match, specific_sim_fun=0):
    """
